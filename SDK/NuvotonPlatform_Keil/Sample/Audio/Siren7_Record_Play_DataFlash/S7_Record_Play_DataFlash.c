...
#define RECORD_START_ADDR		0x10000		//0x10000 = 64KB
#define MAX_RECORD_COUNT		16 * 16 * 1024	//maximum sampling points for 64KB data flash with Siren7 encode
...
int32_t main (void)
{
	...
	Record2DataFlash(RECORD_START_ADDR,MAX_RECORD_COUNT);

	printf("\n=== Play PCM from DataFlash ===\n");
	PlayDataFlash(RECORD_START_ADDR,MAX_RECORD_COUNT);
