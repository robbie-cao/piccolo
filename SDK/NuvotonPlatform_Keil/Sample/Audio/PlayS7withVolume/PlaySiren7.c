...
void VolumeControl(int16_t *pi16Src, uint16_t u16PcmCount)		   // 0=< u8Vol <=16
{
uint8_t u8Vol;
uint16_t u16temp;
int16_t	PcmValue;
...
void CopySoundData(void)
{
	...
	VolumeControl((int16_t *)BufferEmptyAddr, AUDIOBUFFERSIZE);  	//Only support 0<= volume <=16
