...
typedef struct
{
	...
	__IO uint32_t           ClkDivideBy;
	__IO uint32_t           OSR;
	ADCIntControl_t         IntControl;
	ADCDmaControl_t			DmaControl;
	ADCmprControl_t         CmprControl[2];
} ADC_struct;
...
typedef struct
{
	...
	__I  uint32_t  RESERVE1:1;
	__IO uint32_t  PIN_ENB:1;
	__IO uint32_t  TIMER_EN:1;
	__I  uint32_t  RESERVE2:2;
	__IO uint32_t  TIMER_SEL:4;
	__IO uint32_t  PIN_WAKE:1;
	__IO uint32_t  TIMER_WAKE:1;
	__IO uint32_t  POI_WAKE:1;
    __I  uint32_t  RESRVE:5;
} SYSCLK_PWRCON_struct;
...
typedef struct
{
    ...
    __IO uint32_t  TMR3_EN:1;
    __IO uint32_t  FDIV_EN:1;
	__IO uint32_t  SBRAM_EN:1;
    __IO uint32_t  I2C0_EN:1;
    __IO uint32_t  I2C1_EN:1;
    __I  uint32_t  RESERVE1:2;
	__IO uint32_t  SPI0_EN:1;
    __IO uint32_t  DPWM_EN:1;
    __IO uint32_t  SPI2_EN:1;
    __IO uint32_t  SPI3_EN:1;
    __IO uint32_t  UART0_EN:1;
    __IO uint32_t  UART1_EN:1;
...
typedef struct
{
    SYSCLK_PWRCON_struct     PWRCON;
    SYSCLK_AHBCLK_T          AHBCLK;
    SYSCLK_APBCLK_struct    APBCLK;
    uint32_t           RESERVED0;
    SYSCLK_CLKSEL0_T   CLKSEL0;
    SYSCLK_CLKSEL1_T   CLKSEL1;
    SYSCLK_CLKDIV_T    CLKDIV;
...
typedef struct
{
    __IO uint32_t SSB0:1;
    __IO uint32_t SCLK:1;
    __IO uint32_t MISO:1;
    __IO uint32_t MOSI:1;
    __IO uint32_t BCLK:1;
    __IO uint32_t FS:1;
    __IO uint32_t SDI:1;
    __IO uint32_t SDO:1;
    __IO uint32_t TX:1;
...
typedef struct
{
	...
	__IO uint32_t	BODEN;
	__IO uint32_t	TALARMSEL;
	__IO uint32_t	TALARMEN;
	__IO uint32_t	FLREG;	// flash regulator
	__IO uint32_t	FLREGPD;  // flash regulator power down
	...
	__IO uint32_t	PGAEN;
	__IO uint32_t	PGAMUTE;
	__IO uint32_t	PGASEL;
	__IO uint32_t	PGASCK;
	__I  uint32_t	RESERVE5[4];
	__IO uint32_t	OSC;
	__IO uint32_t	TRIM;
	__IO uint32_t	FINETRIM;
} ANA_T;
...
#define SDADC               ((ADC_struct*) ADC_BASE)
...
#define Clock_Manager       ((SYSCLK_struct*) SYSCLK_BASE)


#define SYS                 ((GCR_T *) GCR_BASE)
#define System_Manager      ((System_Manager_struct*) GCR_BASE)
...
#define PDMA                ((PDMA_struct*) PDMA0_BASE)
